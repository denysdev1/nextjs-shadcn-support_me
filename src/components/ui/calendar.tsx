  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: 'flex',
        head_cell:
          'text-muted-foreground rounded-md w-12 max-w-12 font-normal text-[0.8rem]',
        ...
        Dropdown: ({ ...dropdownProps }) => {
          ...
          if (dropdownProps.name === 'months') {
            ...
            if (earliestYear && latestYear) {
              const yearsRange = latestYear - earliestYear + 1;

              selectValues = Array.from({ length: yearsRange }, (_, i) => ({
